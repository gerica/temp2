...
extension GetUser$Query$UserExtension on GetUser$Query$User {
  UserEntity get toEntity => UserEntity(id: $id, firstName: firstName, lastName: lastName, email: email, image: image);
}

extension UpdateUser$Mutation$UpdateByIdUserPayload$Extension on UpdateUser$Mutation$UpdateByIdUserPayload {
