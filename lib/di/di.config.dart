...
import '../core/domain/managers/user_manager_implementation.dart' as _i54;
...
import '../core/domain/use_cases/auth/change_password_use_case.dart' as _i53;
...
import '../core/domain/use_cases/user/update_user_profile_use_case.dart'
    as _i52;
import 'modules/device_module.dart' as _i57;
import 'modules/local_module.dart' as _i58;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init(
    ...
    gh.factory<_i51.SetUserUseCase>(() => _i51.SetUserUseCase(
        get<_i32.AuthRepository>(), get<_i48.UserManager>()));
    gh.factory<_i52.UpdateUserProfileUseCase>(
        () => _i52.UpdateUserProfileUseCase(get<_i28.UserRepository>()));
    gh.factory<_i53.ChangePasswordUseCase>(() => _i53.ChangePasswordUseCase(
        get<_i32.AuthRepository>(), get<_i51.SetUserUseCase>()));
    gh.singleton<_i48.UserManager>(_i54.UserManagerImplementation());
    gh.singleton<_i16.DeviceRepository>(
        _i55.DeviceRepositoryImplementation(get<_i4.FlutterBlue>()));
...
class _$DeviceModule extends _i57.DeviceModule {}
