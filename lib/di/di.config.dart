...
import '../core/data/data_sources/local/auth_local_data_source_implementation.dart'
    as _i11;
import '../core/data/data_sources/remote/auth_remote_data_source.dart' as _i12;
...
import '../core/data/network/dio_client.dart' as _i17;
...
import '../core/device/repository/device_repository_implementation.dart'
    as _i22;
import '../core/domain/managers/user_manager.dart' as _i19;
import '../core/domain/managers/user_manager_implementation.dart' as _i20;
import '../core/domain/repositories/auth/auth_repository.dart' as _i14;
import '../core/domain/repositories/device/device_repository.dart' as _i21;
import '../core/domain/use_cases/auth/check_if_has_user_logged_in_use_case.dart'
    as _i16;
import '../core/domain/use_cases/auth/set_user_use_case.dart' as _i18;
import 'modules/device_module.dart' as _i24;
import 'modules/local_module.dart' as _i25;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init(
    ...
    gh.factory<_i12.AuthRemoteDataSource>(
        () => _i13.AuthDataSourceImplementation(get<_i6.GraphQLClient>()));
    gh.factory<_i14.AuthRepository>(() => _i15.AuthRepositoryImplementation(
        get<_i12.AuthRemoteDataSource>(), get<_i10.AuthLocalDataSource>()));
    gh.factory<_i16.CheckIfUserIsLoggedInUseCase>(
        () => _i16.CheckIfUserIsLoggedInUseCase(get<_i14.AuthRepository>()));
    gh.factory<_i17.DioClient>(() => remoteModule.provideApi(
        get<_i3.Dio>(), get<_i3.InterceptorsWrapper>()));
    gh.factory<_i18.SetUserUseCase>(() => _i18.SetUserUseCase(
        get<_i14.AuthRepository>(), get<_i19.UserManager>()));
    gh.singleton<_i19.UserManager>(_i20.UserManagerImplementation());
    gh.singleton<_i21.DeviceRepository>(
        _i22.DeviceRepositoryImplementation(get<_i4.FlutterBlue>()));
...
class _$DeviceModule extends _i24.DeviceModule {}
