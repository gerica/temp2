...
import '../core/data/network/dio_client.dart' as _i38;
...
import '../core/device/repository/device_repository_implementation.dart'
    as _i58;
import '../core/domain/managers/user_manager.dart' as _i50;
import '../core/domain/managers/user_manager_implementation.dart' as _i57;
...
import '../core/domain/repositories/exams_repository.dart' as _i41;
...
import '../core/domain/use_cases/auth/change_password_use_case.dart' as _i56;
...
import '../core/domain/use_cases/auth/log_out_use_case.dart' as _i49;
import '../core/domain/use_cases/auth/reset_password_use_case.dart' as _i51;
import '../core/domain/use_cases/auth/set_user_use_case.dart' as _i53;
...
import '../core/domain/use_cases/exams/get_exams_use_case.dart' as _i44;
...
import '../core/domain/use_cases/my_devices/get_my_devices_use_case.dart'
    as _i45;
import '../core/domain/use_cases/plans/get_plans_use_case.dart' as _i46;
import '../core/domain/use_cases/user/get_user_id_use_case.dart' as _i47;
import '../core/domain/use_cases/user/get_user_profile_use_case.dart' as _i48;
import '../core/domain/use_cases/user/image_to_base64_use_case.dart' as _i8;
import '../core/domain/use_cases/user/save_user_id_use_case.dart' as _i52;
...
import '../core/domain/use_cases/user/update_user_profile_use_case.dart'
    as _i55;
import 'modules/device_module.dart' as _i60;
import 'modules/local_module.dart' as _i61;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init(
    ...
    gh.factory<_i37.ConfirmRegisterUseCase>(
        () => _i37.ConfirmRegisterUseCase(get<_i19.MyDeviceRepository>()));
    gh.factory<_i38.DioClient>(() => remoteModule.provideApi(
        get<_i3.Dio>(), get<_i3.InterceptorsWrapper>()));
    gh.factory<_i39.ExamsRemoteDataSource>(() =>
        _i40.ExamsRemoteDataSourceImplementation(get<_i6.GraphQLClient>()));
    gh.factory<_i41.ExamsRepository>(() =>
        _i42.ExamsRepositoryImplementation(get<_i39.ExamsRemoteDataSource>()));
    gh.factory<_i43.GetDeviceCheckRegisterUseCase>(() =>
        _i43.GetDeviceCheckRegisterUseCase(get<_i19.MyDeviceRepository>()));
    gh.factory<_i44.GetExamsUseCase>(
        () => _i44.GetExamsUseCase(get<_i41.ExamsRepository>()));
    gh.factory<_i45.GetMyDevicesUseCase>(
        () => _i45.GetMyDevicesUseCase(get<_i19.MyDeviceRepository>()));
    gh.factory<_i46.GetPlansUseCase>(
        () => _i46.GetPlansUseCase(get<_i23.PlansRepository>()));
    gh.factory<_i47.GetUserIdUseCase>(
        () => _i47.GetUserIdUseCase(get<_i28.UserRepository>()));
    gh.factory<_i48.GetUserProfileUseCase>(
        () => _i48.GetUserProfileUseCase(get<_i28.UserRepository>()));
    gh.factory<_i49.LogOutUseCase>(() => _i49.LogOutUseCase(
        get<_i32.AuthRepository>(), get<_i50.UserManager>()));
    gh.factory<_i51.ResetPasswordUseCase>(
        () => _i51.ResetPasswordUseCase(get<_i32.AuthRepository>()));
    gh.factory<_i52.SaveUserIdUseCase>(
        () => _i52.SaveUserIdUseCase(get<_i28.UserRepository>()));
    gh.factory<_i53.SetUserUseCase>(() => _i53.SetUserUseCase(
        get<_i32.AuthRepository>(), get<_i50.UserManager>()));
    gh.factory<_i54.UpdateUserPasswordUseCase>(
        () => _i54.UpdateUserPasswordUseCase(get<_i28.UserRepository>()));
    gh.factory<_i55.UpdateUserProfileUseCase>(
        () => _i55.UpdateUserProfileUseCase(get<_i28.UserRepository>()));
    gh.factory<_i56.ChangePasswordUseCase>(() => _i56.ChangePasswordUseCase(
...
class _$RemoteModule extends _i59.RemoteModule {}

class _$DeviceModule extends _i60.DeviceModule {}

class _$LocalModule extends _i61.LocalModule {}
