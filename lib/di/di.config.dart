...
import '../core/data/network/dio_client.dart' as _i32;
...
import '../core/device/repository/device_repository_implementation.dart'
    as _i49;
import '../core/domain/managers/user_manager.dart' as _i42;
import '../core/domain/managers/user_manager_implementation.dart' as _i48;
import '../core/domain/repositories/auth/auth_repository.dart' as _i27;
import '../core/domain/repositories/device/device_repository.dart' as _i16;
import '../core/domain/repositories/exams_repository.dart' as _i35;
import '../core/domain/repositories/my_device/my_device_repository.dart'
    as _i19;
import '../core/domain/repositories/user/user_repository.dart' as _i23;
import '../core/domain/use_cases/auth/change_password_use_case.dart' as _i47;
import '../core/domain/use_cases/auth/check_if_has_user_logged_in_use_case.dart'
    as _i30;
import '../core/domain/use_cases/auth/check_if_user_was_confirmed.dart' as _i31;
import '../core/domain/use_cases/auth/log_out_use_case.dart' as _i41;
import '../core/domain/use_cases/auth/reset_password_use_case.dart' as _i43;
import '../core/domain/use_cases/auth/set_user_use_case.dart' as _i45;
...
import '../core/domain/use_cases/exams/get_exams_use_case.dart' as _i37;
import '../core/domain/use_cases/my_devices/get_my_devices_use_case.dart'
    as _i38;
import '../core/domain/use_cases/user/get_user_id_use_case.dart' as _i39;
import '../core/domain/use_cases/user/get_user_profile_use_case.dart' as _i40;
import '../core/domain/use_cases/user/image_to_base64_use_case.dart' as _i8;
import '../core/domain/use_cases/user/save_user_id_use_case.dart' as _i44;
import '../core/domain/use_cases/user/update_user_profile_use_case.dart'
    as _i46;
import 'modules/device_module.dart' as _i51;
import 'modules/local_module.dart' as _i52;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init(
    ...
    gh.factory<_i21.UserRemoteDataSource>(() =>
        _i22.UserRemoteDataSourceImplementation(get<_i6.GraphQLClient>()));
    gh.factory<_i23.UserRepository>(() => _i24.UserRepositoryImplementation(
        get<_i21.UserRemoteDataSource>(), get<_i11.UserLocalDataSource>()));
    gh.factory<_i25.AuthRemoteDataSource>(
        () => _i26.AuthDataSourceImplementation(get<_i6.GraphQLClient>()));
    gh.factory<_i27.AuthRepository>(() => _i28.AuthRepositoryImplementation(
        get<_i25.AuthRemoteDataSource>(), get<_i13.AuthLocalDataSource>()));
    gh.factory<_i29.CheckConnectivityUseCase>(
        () => _i29.CheckConnectivityUseCase(get<_i16.DeviceRepository>()));
    gh.factory<_i30.CheckIfUserIsLoggedInUseCase>(
        () => _i30.CheckIfUserIsLoggedInUseCase(get<_i27.AuthRepository>()));
    gh.factory<_i31.CheckIfUserWasConfirmed>(
        () => _i31.CheckIfUserWasConfirmed(get<_i27.AuthRepository>()));
    gh.factory<_i32.DioClient>(() => remoteModule.provideApi(
        get<_i3.Dio>(), get<_i3.InterceptorsWrapper>()));
    gh.factory<_i33.ExamsRemoteDataSource>(() =>
        _i34.ExamsRemoteDataSourceImplementation(get<_i6.GraphQLClient>()));
    gh.factory<_i35.ExamsRepository>(() =>
        _i36.ExamsRepositoryImplementation(get<_i33.ExamsRemoteDataSource>()));
    gh.factory<_i37.GetExamsUseCase>(
        () => _i37.GetExamsUseCase(get<_i35.ExamsRepository>()));
    gh.factory<_i38.GetMyDevicesUseCase>(
        () => _i38.GetMyDevicesUseCase(get<_i19.MyDeviceRepository>()));
    gh.factory<_i39.GetUserIdUseCase>(
        () => _i39.GetUserIdUseCase(get<_i23.UserRepository>()));
    gh.factory<_i40.GetUserProfileUseCase>(
        () => _i40.GetUserProfileUseCase(get<_i23.UserRepository>()));
    gh.factory<_i41.LogOutUseCase>(() => _i41.LogOutUseCase(
        get<_i27.AuthRepository>(), get<_i42.UserManager>()));
    gh.factory<_i43.ResetPasswordUseCase>(
        () => _i43.ResetPasswordUseCase(get<_i27.AuthRepository>()));
    gh.factory<_i44.SaveUserIdUseCase>(
        () => _i44.SaveUserIdUseCase(get<_i23.UserRepository>()));
    gh.factory<_i45.SetUserUseCase>(() => _i45.SetUserUseCase(
        get<_i27.AuthRepository>(), get<_i42.UserManager>()));
    gh.factory<_i46.UpdateUserProfileUseCase>(
        () => _i46.UpdateUserProfileUseCase(get<_i23.UserRepository>()));
    gh.factory<_i47.ChangePasswordUseCase>(() => _i47.ChangePasswordUseCase(
        get<_i27.AuthRepository>(), get<_i45.SetUserUseCase>()));
    gh.singleton<_i42.UserManager>(_i48.UserManagerImplementation());
    gh.singleton<_i16.DeviceRepository>(
        _i49.DeviceRepositoryImplementation(get<_i4.FlutterBlue>()));
...
class _$RemoteModule extends _i50.RemoteModule {}

class _$DeviceModule extends _i51.DeviceModule {}
