...
import '../core/data/network/dio_client.dart' as _i39;
...
import '../core/device/repository/device_repository_implementation.dart'
    as _i59;
import '../core/domain/managers/user_manager.dart' as _i51;
import '../core/domain/managers/user_manager_implementation.dart' as _i58;
...
import '../core/domain/repositories/exams_repository.dart' as _i42;
...
import '../core/domain/use_cases/auth/change_password_use_case.dart' as _i57;
...
import '../core/domain/use_cases/auth/log_out_use_case.dart' as _i50;
import '../core/domain/use_cases/auth/reset_password_use_case.dart' as _i52;
import '../core/domain/use_cases/auth/set_user_use_case.dart' as _i54;
import '../core/domain/use_cases/device/check_connectivity_use_case.dart'
    as _i34;
import '../core/domain/use_cases/device/configure_wifi_use_case.dart' as _i37;
import '../core/domain/use_cases/device/get_wifi_ssid_use_case.dart' as _i15;
import '../core/domain/use_cases/exams/get_exams_use_case.dart' as _i45;
import '../core/domain/use_cases/my_devices/confirm_regiser_use_case.dart'
    as _i38;
...
import '../core/domain/use_cases/my_devices/get_my_devices_use_case.dart'
    as _i46;
import '../core/domain/use_cases/plans/get_plans_use_case.dart' as _i47;
import '../core/domain/use_cases/user/get_user_id_use_case.dart' as _i48;
import '../core/domain/use_cases/user/get_user_profile_use_case.dart' as _i49;
import '../core/domain/use_cases/user/image_to_base64_use_case.dart' as _i8;
import '../core/domain/use_cases/user/save_user_id_use_case.dart' as _i53;
...
import '../core/domain/use_cases/user/update_user_profile_use_case.dart'
    as _i56;
import 'modules/device_module.dart' as _i61;
import 'modules/local_module.dart' as _i62;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  Future<_i1.GetIt> init(
    ...
    gh.factory<_i37.ConfigureWifiUseCase>(
        () => _i37.ConfigureWifiUseCase(get<_i16.DeviceRepository>()));
    gh.factory<_i38.ConfirmRegisterUseCase>(
        () => _i38.ConfirmRegisterUseCase(get<_i19.MyDeviceRepository>()));
    gh.factory<_i39.DioClient>(() => remoteModule.provideApi(
        get<_i3.Dio>(), get<_i3.InterceptorsWrapper>()));
    gh.factory<_i40.ExamsRemoteDataSource>(() =>
        _i41.ExamsRemoteDataSourceImplementation(get<_i6.GraphQLClient>()));
    gh.factory<_i42.ExamsRepository>(() =>
        _i43.ExamsRepositoryImplementation(get<_i40.ExamsRemoteDataSource>()));
    gh.factory<_i44.GetDeviceCheckRegisterUseCase>(() =>
        _i44.GetDeviceCheckRegisterUseCase(get<_i19.MyDeviceRepository>()));
    gh.factory<_i45.GetExamsUseCase>(
        () => _i45.GetExamsUseCase(get<_i42.ExamsRepository>()));
    gh.factory<_i46.GetMyDevicesUseCase>(
        () => _i46.GetMyDevicesUseCase(get<_i19.MyDeviceRepository>()));
    gh.factory<_i47.GetPlansUseCase>(
        () => _i47.GetPlansUseCase(get<_i23.PlansRepository>()));
    gh.factory<_i48.GetUserIdUseCase>(
        () => _i48.GetUserIdUseCase(get<_i28.UserRepository>()));
    gh.factory<_i49.GetUserProfileUseCase>(
        () => _i49.GetUserProfileUseCase(get<_i28.UserRepository>()));
    gh.factory<_i50.LogOutUseCase>(() => _i50.LogOutUseCase(
        get<_i32.AuthRepository>(), get<_i51.UserManager>()));
    gh.factory<_i52.ResetPasswordUseCase>(
        () => _i52.ResetPasswordUseCase(get<_i32.AuthRepository>()));
    gh.factory<_i53.SaveUserIdUseCase>(
        () => _i53.SaveUserIdUseCase(get<_i28.UserRepository>()));
    gh.factory<_i54.SetUserUseCase>(() => _i54.SetUserUseCase(
        get<_i32.AuthRepository>(), get<_i51.UserManager>()));
    gh.factory<_i55.UpdateUserPasswordUseCase>(
        () => _i55.UpdateUserPasswordUseCase(get<_i28.UserRepository>()));
    gh.factory<_i56.UpdateUserProfileUseCase>(
        () => _i56.UpdateUserProfileUseCase(get<_i28.UserRepository>()));
    gh.factory<_i57.ChangePasswordUseCase>(() => _i57.ChangePasswordUseCase(
        get<_i32.AuthRepository>(), get<_i54.SetUserUseCase>()));
    gh.singleton<_i51.UserManager>(_i58.UserManagerImplementation());
    gh.singleton<_i16.DeviceRepository>(
        _i59.DeviceRepositoryImplementation(get<_i4.FlutterBlue>()));
...
class _$DeviceModule extends _i61.DeviceModule {}
